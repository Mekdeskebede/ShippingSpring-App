...
public class GeoLocationServiceImpl implements GeoLocationService {
    ...
    @Autowired
    public GeoLocationServiceImpl(@Value("AIzaSyAGYnzWlOETeeWZy6RZeuiW_w7ysfIXwaU") String apiKey) {
    ...
    public Optional<GeoLocation> computeGeoLocation(String fullAddressLine) {
        ...
        try {
            ...
            log.error("Encountered error [{}] using GoogleMapsApi for address {} : {}", e.getMessage(), fullAddressLine,
                    e);
        }
